...
return [
    ...
    "A fresh verification link has been sent to your email address."=> "Link weryfikacyjny został wysłany na twój adres email.",
    ...
    "Attach =>resource"=> "\/ Align = \"left\" \/ =>resource",
    "August"=> "Sierpień",
    "Australia"=> "Australia",
    "Austria"=> "Austria",
    ...
    "Barbados"=> "Barbados",
    "Before proceeding, please check your email for a verification link."=> "Zanim przejdziesz dalej, sprawdź swój adres email po link weryfikacyjny.",
    "Belarus"=> "Białoruś",
    "Belgium"=> "Belgia",
    "Belize"=> "Belize",
    "Benin"=> "Benin",
    ...
    "City"=> "City",
    "click here to request another"=> "kliknij tutaj, aby poprosić ponownie",
    ...
    "could not be found."=> "nie można znaleźć.",
    "Country"=> "Country",
    "Coupon"=> "Coupon",
    "Create"=> "Utworz",
    ...
    "Email Password Reset Link"=> "Link do resetowania hasła email-em",
    "Enable"=> "Włącz",
    ...
    "Great! You have accepted the invitation to join the =>team team."=> "Świetny! Zaakceptowałeś zaproszenie do zespołu =>team.",
    "Greece"=> "Grecja",
    ...
    "If you did not receive the email"=> "Jeśli nie dotarła wiadomość email",
    ...
    "If you do not have an account, you may create one by clicking the button below. After creating an account, you may click the invitation acceptance button in this email to accept the team invitation=>"=> "Jeśli nie masz konta, możesz je utworzyć, klikając przycisk poniżej. Po utworzeniu konta możesz kliknąć przycisk akceptacji zaproszenia w tej wiadomości e-mail, aby zaakceptować zaproszenie do zespołu=>",
    ...
    "Login"=> "Zaloguj się",
    "Logout"=> "Wyloguj się",
    "Logout Other Browser Sessions"=> "Wyloguj się z innych sesji przeglądarek",
    ...
    "Manage and logout your active sessions on other browsers and devices."=> "Zarządzaj aktywnymi sesjami w innych przeglądarkach i urządzeniach oraz wyloguj się z nich.",
    ...
    "Niue"=> "Niue",
    "No"=> "Nie.",
    "No =>resource matched the given criteria."=> "No =>resource pasowało do podanych kryteriów.",
    ...
    "Pagination Navigation"=> "Paginacja",
    "Pakistan"=> "Pakistan",
    "Palau"=> "Palau",
    ...
    "Please confirm your password before continuing."=> "Aby kontynuować, potwierdź swoje hasło.",
    ...
    "Please enter your password to confirm you would like to logout of your other browser sessions across all of your devices."=> "Wprowadź hasło, aby potwierdzić, że chcesz wylogować się z innych sesji przeglądarek na wszystkich urządzeniach.",
    ...
    "Please provide the email address of the person you would like to add to this team. The email address must be associated with an existing account."=> "Podaj adres email osoby, którą chcesz dodać do tego zespołu. Adres email musi być powiązany z istniejącym kontem.",
    ...
    "Reset Password Notification"=> "Zresetuj hasło",
    "resource"=> "zasób",
    "Resources"=> "Zasoby",
    "resources"=> "zasoby",
    "Restore"=> "Przywróć",
    ...
    "Rwanda"=> "Rwanda",
    "Réunion"=> "Réunion",
    "Saint Barthelemy"=> "Święty Bartłomiej",
    ...
    "The =>resource was created!"=> "\/ Align = \"center\" \/ 3,0869",
    ...
    "These people have been invited to your team and have been sent an invitation email. They may join the team by accepting the email invitation."=> "Osoby te zostały zaproszone do Twojego zespołu i został wysłany e-mail z zaproszeniem. Mogą dołączyć do zespołu, akceptując zaproszenie e-mail.",
    "This account does not have an active subscription."=> "This account does not have an active subscription.",
    "This action is unauthorized."=> "To działanie nie zostało autoryzowane.",
    ...
    "Tonga"=> "Przychodzić",
    "Too Many Attempts."=> "Za dużo prób.",
    ...
    "Two factor authentication is now enabled. Scan the following QR code using your phone's authenticator application."=> "Uwierzytelnianie dwuskładnikowe jest teraz włączone. Uwierzytelnianie dwuskładnikowe jest teraz włączone. Zeskanować poniższy kod QR przy użyciu aplikacji Authenticator w telefonie.",
    "Uganda"=> "Uganda",
    "Ukraine"=> "Ukraina",
    ...
    "We won't ask for your password again for a few hours."=> "Nie będziemy prosić o kolejne hasło przez kilka następnych godzin.",
